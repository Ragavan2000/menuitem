...
namespace MenuItemListing.Controllers
{
    ...
    public class MenuItemController : ControllerBase
    {
        ...
        public List<MenuItem> GetItem()
        {
            ...
            {   new MenuItem() {Id=1, Name="IPhone", Active=true, DateOfLaunch=new DateTime(2018,07,05), FreeDelivery=false,Price=20000},
                new MenuItem() {Id=2, Name="Desktop", Active=false, DateOfLaunch=new DateTime(2011,27,11), FreeDelivery=false,Price=40000}
